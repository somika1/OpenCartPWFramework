...
test.skip('get user data',async({request})=>{
...
test.skip('create new user',async({request})=>{
    let user={
...
test.skip('update existing user',async({request})=>{
    let user={
        name: 'Shridevi Gupta',
        email: `sharma_${Date.now()}@yahoo.example`,
        gender: 'female',
...
test.skip('update existing user using patch',async({request})=>{
    let user={
        //name: 'Shridevi Gupta',
        email: `sharma_${Date.now()}@yahoo.example`,
        // gender: 'female',
...
test.skip('delete existing user',async({request})=>{
